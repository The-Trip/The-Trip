/// NB clean-up reducers
/// removeFlightsFromDB reducer replicates receiveFlightsFromDB

export function fetchFlights(flyFrom, flyTo, dateFrom, dateTo) {
  return function(dispatch) {
    return fetch(
      `https://api.skypicker.com/flights?flyFrom=${flyFrom}&to=${flyTo}&dateFrom=${dateFrom}&dateTo=${dateFrom}&returnFrom=${dateTo}&returnTo=${dateTo}&max_stopovers=0&curr=GBP&limit=5`
    )
